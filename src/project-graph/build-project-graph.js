...
function buildProjectGraphUsingProjectFileMap(projectsConfigurations, projectFileMap, allWorkspaceFiles, cache, shouldWriteCache) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const normalizedNxJson = (0, normalize_nx_json_1.normalizeNxJson)(nxJson, Object.keys(projectsConfigurations.projects));
        const packageJsonDeps = readCombinedDeps();
        const rootTsConfig = readRootTsConfig();
        let filesToProcess;
        let cachedFileData;
        if (cache &&
            !(0, nx_deps_cache_1.shouldRecomputeWholeGraph)(cache, packageJsonDeps, projectsConfigurations, normalizedNxJson, rootTsConfig)) {
        ...
        const context = createContext(projectsConfigurations, normalizedNxJson, projectFileMap, filesToProcess);
        ...
        if (shouldWriteCache) {
            (0, nx_deps_cache_1.writeCacheIfNecessary)(projectGraphCache, cache);
        }
