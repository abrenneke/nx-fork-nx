...
const jest_worker_task_runner_1 = require("./jest-worker-task-runner");
const forked_process_task_runner_1 = require("./forked-process-task-runner");
class TaskOrchestrator {
    // endregion internal state
    constructor(hasher, initiatingProject, projectGraph, taskGraph, options, bail) {
        this.hasher = hasher;
        ...
        this.taskRunner = process
            .env.NX_JEST_WORKER_TASK_RUNNER
            ? new jest_worker_task_runner_1.JestWorkerTaskRunner(this.options, this.projectGraph)
            : new forked_process_task_runner_1.ForkedProcessTaskRunner(this.options);
    ...
    runBatch(batch) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const results = yield this.taskRunner.forkProcessForBatch(batch);
    ...
    runTaskInForkedProcess(task) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // execution
                if (this.taskRunner instanceof jest_worker_task_runner_1.JestWorkerTaskRunner) {
                    return yield this.taskRunner.executeTask(task, {
                        temporaryOutputPath,
                        streamOutput,
                    });
                }
                if (pipeOutput) {
                    return yield this.taskRunner.forkProcessPipeOutputCapture(task, {
                        temporaryOutputPath,
                        streamOutput,
                    });
                }
                return yield this.taskRunner.forkProcessDirectOutputCapture(task, {
                    temporaryOutputPath,
                    streamOutput,
                });
            }
