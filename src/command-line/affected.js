            ...
            switch (command) {
                ...
                case 'print-affected':
                    if (nxArgs.target) {
                        ...
                        yield (0, print_affected_1.printAffected)(projectsWithTarget, projects, projectGraph, { nxJson }, nxArgs, overrides);
                    }
                    else {
                ...
                case 'affected': {
                    const projectsWithTarget = allProjectsWithTarget(projects, nxArgs);
                    yield (0, run_command_1.runCommand)(projectsWithTarget, projectGraph, { nxJson }, nxArgs, overrides, null, extraTargetDependencies);
                    break;
                }
            }
        }
